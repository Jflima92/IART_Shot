...
public class Logic {
	...
	//fun�ao que move a primeira bola
	public int moveBall(int i,int dir ){
		...
		{
			//o nextball modifica a posi�ao da primeira bola e retorna o indice da bola em que acertou
			movepriority.add(i);
			int bola = nextball(i,dir);
			moveBall2(bola, dir);//continua o movimento, agora com a 2� bola, s� p�ra quando nao houver mais colis�es de bolas
	...
	//modifica a posi�ao da bola apos a colis�o, e continua recursivamente ate acabarem as colis�es
	...
	// verifica se pode mexer a bola, isto �, se tem mais bolas na direcao e se n�o tem nenhuma imediatamente a seguir
	...
	// verifica se pode mexer a segunda bola, isto �, se tem mais bolas na direcao
	...
	//� chamada depois do moveball ou moveball2, muda a posi�ao da bola que � movida e retorna o indice da bola seguinte a mover
